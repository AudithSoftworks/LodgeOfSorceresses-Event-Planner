...
class ContentTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $data = [
            ...
            ['id' => 28, 'name' => 'Veteran Kyne\'s Aegis', 'short_name' => 'vKA', 'version' => 'HM', 'type' => 'endgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_4],
            ...
            ['id' => 33, 'name' => 'Veteran Imperial City Prison', 'short_name' => 'vICP', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_1],
            ['id' => 34, 'name' => 'Veteran White-Gold Tower', 'short_name' => 'vWGT', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_1],
            ['id' => 35, 'name' => 'Veteran Cradle of Shadows', 'short_name' => 'vCOS', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_1],
            ['id' => 36, 'name' => 'Veteran Ruins of Mazzatun', 'short_name' => 'vROM', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_1],
            ...
            ['id' => 38, 'name' => 'Veteran Bloodroot Forge', 'short_name' => 'vBRF', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_2],
            ['id' => 39, 'name' => 'Veteran Falkreath Hold', 'short_name' => 'vFH', 'version' => null, 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_2],
            ['id' => 40, 'name' => 'Veteran Falkreath Hold', 'short_name' => 'vFH', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_2],
            ...
            ['id' => 42, 'name' => 'Veteran Scalecaller Peak', 'short_name' => 'vSCP', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_2],
            ['id' => 43, 'name' => 'Veteran Fang Lair', 'short_name' => 'vFL', 'version' => null, 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_2],
            ['id' => 44, 'name' => 'Veteran Fang Lair', 'short_name' => 'vFL', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_2],
            ...
            ['id' => 46, 'name' => 'Veteran Moonhunter Keep', 'short_name' => 'vMHK', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_3],
            ...
            ['id' => 48, 'name' => 'Veteran March of Sacrifices', 'short_name' => 'vMOS', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_2],
            ...
            ['id' => 50, 'name' => 'Veteran Depths of Malatar', 'short_name' => 'vDOM', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_3],
            ['id' => 51, 'name' => 'Veteran Frostvault', 'short_name' => 'vFV', 'version' => null, 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_2],
            ['id' => 52, 'name' => 'Veteran Frostvault', 'short_name' => 'vFV', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_3],
            ['id' => 53, 'name' => 'Veteran Moongrave Fane', 'short_name' => 'vMF', 'version' => null, 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_2],
            ['id' => 54, 'name' => 'Veteran Moongrave Fane', 'short_name' => 'vMF', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_3],
            ...
            ['id' => 63, 'name' => 'Veteran Castle Thorn', 'short_name' => 'vCS', 'version' => null, 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_2],
            ['id' => 64, 'name' => 'Veteran Castle Thorn', 'short_name' => 'vCS', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_3],
            ['id' => 65, 'name' => 'Veteran Stone Garden', 'short_name' => 'vSG', 'version' => null, 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_2],
            ['id' => 66, 'name' => 'Veteran Stone Garden', 'short_name' => 'vSG', 'version' => 'HM', 'type' => 'midgame', 'tier' => GuildRanksAndClearance::CLEARANCE_TIER_3],
