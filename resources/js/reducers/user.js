...
const userReducer = (state = null, action) => {
    if (
        action.type === getActions.TYPE_GET_USER_SUCCESS
        || action.type === putActions.TYPE_PUT_USER_SUCCESS
        || action.type === onboardingActions.TYPE_FINALIZE_ONBOARDING_SUCCESS
    ) {
        let newState = {};
