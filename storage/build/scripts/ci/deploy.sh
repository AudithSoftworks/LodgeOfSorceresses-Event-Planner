...
rm -rf ./.git* ./node_modules ./storage/build/tools ./storage/coverage ./tests ./deploy_rsa.enc ./.*.yml ./.travis_env ./_ide_helper.php old;

rsync -r --delete-after -e "ssh -o StrictHostKeyChecking=no" ${TRAVIS_BUILD_DIR}/ lodge-planner@lodgeofsorceresses.com:/opt/lodge-planner/www/${TRAVIS_BUILD_NUMBER}/
