 ...
 * @property bool $has_jewels
 * @property bool $has_weapons
 * @property bool $has_light_armor
 * @property bool $has_medium_armor
 * @property bool $has_heavy_armor
 * @property int|null $traits_needed
 * @property int $pts
